...
import { Nfc, Boxes } from "lucide-react";
              ...
              return (
                ...
                >
                  <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-electric-500/12 text-glow-400">
                    <PartnerIcon size={24} strokeWidth={1.75} />
                  </span>
                  <h3 className="mt-5 font-[family-name:var(--font-space-grotesk)] text-2xl font-bold text-white">
                    {p.name}
                  </h3>
